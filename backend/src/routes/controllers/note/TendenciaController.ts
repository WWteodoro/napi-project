...
import { TendenciaService } from "../../../services/NoteService/TendenciaSazonalService";
...
export class TendenciaController {
    ...
    async handle(req: Request, res: Response): Promise<Response>{
        ...
        const exportFullyCSVService = new TendenciaService(this.noteRepo);
        ...
        try {
            ...
            return res.status(500).json({ error: "Falha ao gerar tendencia sazonal" });
        }
    }
}