...
export class CreateNoteService{
    constructor(private noteRepo: INoteRepository){}
        async execute({quantity, dateTime, location, content, animal, time, userId, videoId}: INoteCreateRequest ): Promise<INote>{
            const note = new Note({quantity, dateTime, location, content, animal, time, userId, videoId})
